...
insert into mobble_dispatcher.fuel_type ( type)
values  ( 'diesel'),
        ( 'electricity');


insert into mobble_dispatcher.carbon_footprint ( fuel_type_id, seats_size, cf_value, fuel_efficiency, vehicle_price, cf_unit, fe_diesel_unit, fe_electricity_unit, create_time, update_time)
values  ( 1, 45, 34, 4, 250000000, 'g/km', 'km/l', 'km/w', '2024-04-14 03:53:00.838229', null),
        ( 1, 25, 22, 6, 180000000, 'g/km', 'km/l', 'km/w', '2024-04-14 03:53:14.303118', null),
        ( 1, 16, 16, 7, 80000000, 'g/km', 'km/l', 'km/w', '2024-04-14 03:57:15.420613', null),
        ( 2, 45, 0, 3, 250000000, 'g/km', 'km/l', 'km/w', '2024-04-14 03:58:20.811674', null),
        ( 2, 25, 0, 4, 180000000, 'g/km', 'km/l', 'km/w', '2024-04-14 03:58:20.811674', null),
        ( 2, 16, 0, 5, 80000000, 'g/km', 'km/l', 'km/w', '2024-04-14 03:58:20.811674', null);


insert into mobble_dispatcher.fare_base (fare_once, fare_month, basic_distance, basic_distance_fare, basic_speed, basic_combined_time, basic_combined_time_fare, basic_combined_distance, basic_combined_distance_fare, create_time, update_time)
values  ( 3000, 50000, 1.6, 3000, 15, 30, 100, 131, 100, '2024-04-14 03:11:57.852123', null);


insert into mobble_dispatcher.stops_virtual ( vstop_name, vstop_loc, nearby_link_id, region_code, stops_area_idx, input_date, address, geom, is_use)
values  ( '상평교차로', '(124,37)', null, 1, null, null, null, '010100002042140000F20F583942C30D4178C0CA81A6A12041', true);

insert into mobble_dispatcher.tranportation_cost_base (diesel_cost, electricity_cost, man_day_cost, man_insurance, vehicle_depreciation_rate, vehicle_insurance, etc_cost, day_run_time, line_price_distance, line_price_time, create_time, update_time)
values  ( 1400, 1200, 187000, 14.1, 10, 200000, 30000, 8, 30000, 150000, '2024-04-14 03:11:44.987329', null);